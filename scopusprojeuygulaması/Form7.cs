...
namespace scopusprojeuygulaması
{
    public partial class Form7 : Form
    {
        ...
        private void Form7_Load(object sender, EventArgs e)
        {
            ...
            // Değerleri ata
            comboBox7.DataSource = distinctIsim2;
            comboBox8.DataSource = distinctYearsIsim2;
        ...
        private void comboBox7_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                string selectedIsim2 = comboBox7.SelectedItem.ToString();
                int selectedYear2 = comboBox8.SelectedItem != null ? Convert.ToInt32(comboBox8.SelectedItem.ToString()) : 0;
                FilterDataGridIsimAndYear2(selectedIsim2, selectedYear2);
            }
            else
            {
                // ComboBox seçilmedi veya "Seçilmedi" seçildiğinde, tam tabloyu göster
                DataTable table = (DataTable)detayliSahis.DataSource;
        ...
        private void comboBox3_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (comboBox3.SelectedItem != null && comboBox3.SelectedItem.ToString() != "Seçilmedi")
            {
                ...
                comboBox7.DataSource = filteredAuthors;
            ...
            else
            {
                ...
                comboBox7.DataSource = allAuthors;
       ...
       comboBox2.SelectedItem != null) // comboBox2.SelectedItem'ı kontrol et
        ...
        private void comboBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                string selectedIsim = comboBox1.SelectedItem.ToString();
                int selectedYear = comboBox2.SelectedItem != null ? Convert.ToInt32(comboBox2.SelectedItem.ToString()) : 0;
                FilterDataGridIsimAndYear(selectedIsim, selectedYear);
            }
            else
            {
        ...
        {
            DataTable table = (DataTable)detayliSahis.DataSource;
            if (isim != "Seçilmedi" && year != 0)
            {
                table.DefaultView.RowFilter = $"[Author Name] = '{isim}' AND Year = '{year}'";
            }
            else if (isim != "Seçilmedi")
            {
                table.DefaultView.RowFilter = $"[Author Name] = '{isim}'";
            }
            else if (year != 0)
            {
                table.DefaultView.RowFilter = $"Year = '{year}'";
            }
            else
            {
                // Display all data
        ...
        private void FilterDataGridIsimAndYear2(string isim, int year)
        {
            DataTable table = (DataTable)detayliAtif.DataSource;
            if (isim != "Seçilmedi" && year != 0)
            {
                table.DefaultView.RowFilter = $"İsim = '{isim}' AND Yıl = '{year}'";
            }
            else if (isim != "Seçilmedi")
            {
                table.DefaultView.RowFilter = $"İsim = '{isim}'";
            }
            else if (year != 0)
            {
                table.DefaultView.RowFilter = $"Yıl = '{year}'";
        ...
        {
            if (comboBox7.SelectedItem != null && comboBox7.SelectedItem.ToString() != "Seçilmedi" &&
         comboBox8.SelectedItem != null) // comboBox8.SelectedItem'ı kontrol et
            {
                string selectedIsim2 = comboBox7.SelectedItem.ToString();
                int selectedYear2 = Convert.ToInt32(comboBox8.SelectedItem.ToString()); // Burada kontrol etmeye gerek yok, çünkü null olamaz.
                FilterDataGridIsimAndYear2(selectedIsim2, selectedYear2);
            }
            else
            {
